...
public class SchoolBean {
    ...
    public SchoolBean( String schoolName, String address, int schoolCode, long schoolContact, String principalName, long principalContact, long aadharNo, String username, String password, String emailId) {
        this.schoolName = schoolName;
        this.address = address;
        this.schoolCode = schoolCode;
        this.schoolContact = schoolContact;
