package com.avi.school_details.entity;
...
public class School_details {
    ...
    public School_details(int id,String school_name, String address, int school_code, long school_contact, String principal_name, long principal_contact, long aadhar_no, String username, String password, String email_id) {
        this.id=id;
        this.school_name = school_name;
        this.address = address;
        this.school_code = school_code;
