package com.avi.faculty_details.entity;
...
public class Faculty_details {
    ...
    public Faculty_details(int id, String faculty_name, String faculty_address, long faculty_contact, long faculty_aadhar_no, Date faculty_birthdate, String faculty_email_id) {
        this.id = id;
        this.faculty_name = faculty_name;
        this.faculty_address = faculty_address;
        this.faculty_contact = faculty_contact;
