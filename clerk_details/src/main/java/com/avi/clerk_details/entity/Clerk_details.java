package com.avi.clerk_details.entity;
...
public class Clerk_details {
    ...
    public Clerk_details(){

    }

    public Clerk_details(int id, String clerk_name, String clerk_address, long clerk_contact, long clerk_aadhar_no, Date clerk_birthdate, String clerk_email_id) {
        this.id = id;
        this.clerk_name = clerk_name;
        this.clerk_address = clerk_address;
        this.clerk_contact = clerk_contact;
